...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    .addStringOption((option) =>
      option.setName("db_id").setDescription("asd").setRequired(true),
    )
    .addStringOption((option) =>
      option
        .setName("db_func_type")
        .setDescription("asd")
        .setRequired(true)
        .addChoices(
          { name: "GET", value: "get" },
    ...
    .addStringOption((option) =>
      option.setName("pocket").setDescription("asd").setRequired(true),
    )
    .addStringOption((option) =>
      option
        .setName("value_type")
    ...
    .addStringOption((option) =>
      option.setName("value").setDescription("asd").setRequired(true),
    )
      ...
      if (value_type === "int") {
        ...
        if (value.toLowerCase() === "true") {
          ...
          await interaction.reply(
            "Booling value only can be `true` or `false`",
          );
        }
      } else {
